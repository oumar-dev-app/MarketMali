...
interface DeliveryRatesStepProps {
  onCompleted: () => void;
}

export default function DeliveryRatesStep({
  onCompleted,
}: DeliveryRatesStepProps) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-gray-500">
            Définissez les frais de livraison pour
            une zone desservie par votre boutique.
          </p>
        </div>
