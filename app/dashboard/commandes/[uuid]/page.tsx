                        ...
                        <section className="rounded-2xl bg-white p-5 shadow-sm sm:p-6">
                            ...
                            <div className="mt-5 grid gap-4 md:grid-cols-[220px_1fr_auto]">
                                <select
                                    ...
                                    className="rounded-xl border border-gray-300 bg-white h-12 shrink-0 whitespace-nowrap overflow-hidden px-3 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                >
                                ...
                                <>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-xl border border-gray-300 bg-white px-3 h-12 shrink-0 whitespace-nowrap overflow-hidden py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:bg-gray-100"
                                        >
                                            <option value="">
                                                {loadingLivreurs
                                                    ? "Chargement..."
